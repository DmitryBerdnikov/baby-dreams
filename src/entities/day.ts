...
const nightDreamAwakening =
	Prisma.validator<Prisma.NightDreamAwakeningsDefaultArgs>()({
		include: {},
	})

export type NightDreamAwakening = Prisma.NightDreamAwakeningsGetPayload<
	typeof nightDreamAwakening
>

export type DateString = string;

export const getTodayDateUTC = (dateString: DateString) =>
	new Date(new Date(dateString).toDateString())
